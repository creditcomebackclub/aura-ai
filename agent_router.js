...
const WRITE_OR_EXTERNAL_PATTERN = /\b(?:send|email|message|schedule|book|create|add|plan|planning|prioriti[sz]e|delete|remove|log|remember|forget|teach|text|telegram)\b/i;
